...
How to search:
Typing a search query in the find dialog and clicking Find Now holds the string for later. Perform the search by canceling the dialog and hitting F3 or clicking Find Next in the dropdown menu.
